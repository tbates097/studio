...
def calculate():
    ...
    result = math.sin((((realError/3600)*math.pi/180)*space)/25.4)*1000
    if realError <= spec:
        ortho_label.config(text="Ortho is in spec!")
...
label1 = tk.Label(window, text="Error (in seconds):")
label1.pack()
...
ortho_label = tk.Label(window, text="")
